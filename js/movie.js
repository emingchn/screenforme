...
function moviedetails(information){
	...
	/*********append********/
		...
		$("div#movie #movie_container #movie_info #movie_info_left #post_description #description").append('<p >'+'Studio: '+ data.studio +'</p>');
		$("div#movie #movie_container #movie_info #movie_info_left #post_description #description").append('<p >'+'Synopsis: ' + data.synopsis +'</p>');
		...
		function searchReviews(data){
			...
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<h3 class="title"> reviews </h3>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="quote">' + reviewsArray[0].quote +'</p>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="critic">' + reviewsArray[0].critic +'</p>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="quote">' + reviewsArray[1].quote +'</p>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="critic">' + reviewsArray[1].critic +'</p>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="quote">' + reviewsArray[2].quote +'</p>');
			$("div#movie #movie_container #movie_info #movie_info_left #reviews").append('<p class="critic">' + reviewsArray[2].critic +'</p>');	
		}
